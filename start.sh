...
wget -q -P bot/helper/ext_utils/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/bot/helper/ext_utils/telegraph_helper.py
...
wget -q -P bot/helper/mirror_utils/download_utils/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/bot/helper/mirror_utils/download_utils/gd_downloader.py
...
wget -q -P bot/helper/mirror_utils/status_utils/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/bot/helper/mirror_utils/status_utils/gd_download_status.py
...
wget -q -P bot/helper/mirror_utils/status_utils/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/bot/helper/mirror_utils/status_utils/zip_status.py
...
wget -q -P bot/modules/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/bot/modules/rss.py
wget -q -P bot/modules/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/bot/modules/search.py
...
wget -q -P qBittorrent/config/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/qBittorrent/config/qBittorrent.conf

wget -q -P web/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/web/nodes.py
wget -q -P web/ https://github.com/$GH_UNAME/$GH_REPO/raw/master/web/wserver.py
